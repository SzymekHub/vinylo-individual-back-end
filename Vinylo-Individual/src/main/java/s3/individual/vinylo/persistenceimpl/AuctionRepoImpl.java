...
public class AuctionRepoImpl implements AuctionRepo {
    ...
    private List<Auction> CreateSomeAuctions() {
        ...
        auctions.add(new Auction(0, "All new EP", vinyl, user, "PLAYBOI CARTI'S NEW EP", 666.00, 999.00, "25/09/2024",
                "01/10/2024"));
        auctions.add(new Auction(1, "All new LP", vinyl2, user2, "The Beatles greatest LP", 250.00, 360.00,
