...
// @Autowired
// // mockMvc is injected by Spring and will provide us means to send http
// requests
...
// void testCreateArtist_ShouldCreateAndReturn201_WhenRequestValid() throws
// Exception {
...
// when(artistService.createArtist(any(Artist.class))).thenReturn(createdArtist);
...
// @Test
// @WithMockUser(roles = "ADMIN")
// void testCreateArtist_ShouldCreateAndReturn400_WhenMIssingFields() throws
// Exception {
...
// void testGetArtistById_shouldReturn200RespondWithArtistByID() throws
// Exception {
...
// when(artistService.updateArtist(eq(artistId),
// any(Artist.class))).thenReturn(updatedArtistBio);
...
// mockMvc.perform(put("/artist/{id}", artistId)
// .contentType(APPLICATION_JSON_VALUE)
// .content(jsonContent))
// .andDo(print())
// .andExpect(status().isOk())
// .andExpect(jsonPath("$.bio").value("NEW Yeah yeah I can sing"));

// verify(artistService).saveArtist(eq(artistId), any(Artist.class));
// }
// }
