...
// // Arrange
// when(artistJPARepo.save(null)).thenThrow(new
// IllegalArgumentException("ArtistEntity cannot be null"));

// // Act & Assert
// assertThrows(IllegalArgumentException.class, () ->
// artistJPARepoImpl.saveArtist(null));
...
// // Arrange
// when(artistJPARepo.findByName("Test
// Artist")).thenReturn(Optional.of(artistEntity));
...
// // Arrange
// when(artistJPARepo.findByName("NonExistent
// Artist")).thenReturn(Optional.empty());
